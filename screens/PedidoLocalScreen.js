...
export default function PedidoLocalScreen({ route, navigation }) {
    const { pupuseriaId, pupuseriaNombre } = route.params;
    ...
    const cargarMenu = async () => {
        try {
            const docRef = doc(db, 'pupuserias', pupuseriaId);
    ...
    const confirmarPedido = async () => {
        ...
        try {
            const qActivos = query(
                ...
                where('pupuseria_id', '==', pupuseriaId),
            ...
            await addDoc(collection(db, 'pedidos'), {
                cliente_uid: 'local',
                tipo_pedido: 'local',
                pupuseria_id: pupuseriaId,
                pupuseria_nombre: pupuseriaNombre,
                detalle,
                total: totalItems,
            ...
            Alert.alert(
                '✅ Pedido registrado',
                `Pedido en local #${numeroPedido.toString().padStart(2, '0')} agregado correctamente.`,
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.header}>
                <TouchableOpacity onPress={() => navigation.goBack()}>
                    <Text style={styles.back}>← Regresar al panel</Text>
                </TouchableOpacity>
                <Text style={styles.titulo}>Pedido en Local</Text>
                <Text style={styles.subtitulo}>{pupuseriaNombre}</Text>
            </View>
            ...
            {menu.length === 0 ? (
                <View style={styles.vacioCentro}>
                    ...
                    <Text style={styles.vacioSub}>Configura tu menú antes de registrar pedidos.</Text>
                </View>
            ) : (
                <>
                    ...
                    <View style={styles.footer}>
                        ...
                        >
                            <Text style={styles.botonTexto}>
                                {cargando ? 'Registrando...' : '🏠 Registrar Pedido en Local'}
                            </Text>
                        </TouchableOpacity>
                    </View>
                </>
...
const styles = StyleSheet.create({
    ...
    boton: { backgroundColor: '#1C0A00', borderRadius: 12, padding: 16, alignItems: 'center' },
